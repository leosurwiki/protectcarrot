...
public static class LPAPIParticleSystems {
	...
	**/
    ...
    #region SetParticleSystemIndex
    /**
	* <summary>Set a particle systems index</summary>
	* <param name="worldPointer">A pointer to the particle system</param>
	* <param name="radius">the new index</param>
	**/
	#if UNITY_IPHONE
	[DllImport ("__Internal")]   
	#else
    ...
    #endregion SetParticleSystemIndex
	...
	**/
	...
	[DllImport ("liquidfundll")]
	#endif
	public static extern IntPtr GetParticlesInShape(IntPtr particleSystemPointer, IntPtr shapePointer, float shapeX, float shapeY, float shapeRotation);
